...
| `09_evidence_segmentation` | Classifier-independent lesion segmentation evidence scaffold and TJDR/FGADR/large-mask segmenter work | `seg_evidence_v1`, `seg_evidence_v2_focal_tversky`, `seg_evidence_v3_tjdr` |
