...
- **Sprint 5 carry-over**: Large 4-channel lesion-mask expansion is now a Sprint 5 improvement item, not a Sprint 4 blocker. Candidate sources are FGADR, DDR segmentation subset, and Retinal-Lesions, with license/access checks before training. Sprint 4 closes with v31 active deployment and research-only lesion evidence diagnostics.
